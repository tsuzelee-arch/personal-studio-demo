/**
 * Icons — global inline-SVG registry (Feather/Lucide style).
 * Single source of truth shared by static HTML and all JS modules, replacing
 * emoji glyphs with consistent monochrome line icons that follow currentColor.
 *
 * Usage:
 *   - Static HTML:  <i class="ico" data-icon="save"></i>   (hydrated on load)
 *   - In JS:        el.innerHTML = window.Icons.get('folder')
 */
(function () {
  'use strict';

  // body → full <svg>. stroke=currentColor so icons inherit text color + hover.
  const S = (body, sw) => `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="${sw || 2}" stroke-linecap="round" stroke-linejoin="round">${body}</svg>`;
  ...
  const I = {
    ...
    folderOpen: S('<path d="m6 14 1.5-2.9A2 2 0 0 1 9.24 10H20a2 2 0 0 1 1.94 2.5l-1.54 6a2 2 0 0 1-1.95 1.5H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h3.93a2 2 0 0 1 1.66.9l.82 1.2a2 2 0 0 0 1.66.9H18a2 2 0 0 1 2 2v2"/>'),
    archive: S('<polyline points="21 8 21 21 3 21 3 8"/><rect x="1" y="3" width="22" height="5"/><line x1="10" y1="12" x2="14" y2="12"/>'),
    hardDrive: S('<line x1="22" y1="12" x2="2" y2="12"/><path d="M5.45 5.11 2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z"/><line x1="6" y1="16" x2="6.01" y2="16"/><line x1="10" y1="16" x2="10.01" y2="16"/>'),
    ...
    plusSquare: S('<rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><line x1="12" y1="8" x2="12" y2="16"/><line x1="8" y1="12" x2="16" y2="12"/>'),
    ...
    chevron: S('<polyline points="6 9 12 15 18 9"/>', 2.5),
    ...
    bot: S('<rect x="3" y="11" width="18" height="10" rx="2"/><circle cx="12" cy="5" r="2"/><path d="M12 7v4"/><line x1="8" y1="16" x2="8" y2="16"/><line x1="16" y1="16" x2="16" y2="16"/>'),
    aperture: S('<circle cx="12" cy="12" r="10"/><line x1="14.31" y1="8" x2="20.05" y2="17.94"/><line x1="9.69" y1="8" x2="21.17" y2="8"/><line x1="7.38" y1="12" x2="13.12" y2="2.06"/><line x1="9.69" y1="16" x2="3.95" y2="6.06"/><line x1="14.31" y1="16" x2="2.83" y2="16"/><line x1="16.62" y1="12" x2="10.88" y2="21.94"/>'),
    ...
    sparkles: S('<path d="M12 3l1.9 5.8a2 2 0 0 0 1.3 1.3L21 12l-5.8 1.9a2 2 0 0 0-1.3 1.3L12 21l-1.9-5.8a2 2 0 0 0-1.3-1.3L3 12l5.8-1.9a2 2 0 0 0 1.3-1.3z"/>'),
    ...
    bulb: S('<path d="M9 18h6"/><path d="M10 22h4"/><path d="M15.09 14c.18-.98.65-1.74 1.41-2.5A4.65 4.65 0 0 0 18 8 6 6 0 0 0 6 8c0 1 .23 2.23 1.5 3.5A4.61 4.61 0 0 1 8.91 14"/>'),
    ...
    pencil: S('<path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"/>'),
    arrowUp: S('<line x1="12" y1="19" x2="12" y2="5"/><polyline points="5 12 12 5 19 12"/>'),
    diamond: S('<polygon points="12 2 22 12 12 22 2 12"/>')
  };

  function get(name) { return I[name] || ''; }

  function hydrate(root) {
    (root || document).querySelectorAll('[data-icon]').forEach(el => {
      const n = el.getAttribute('data-icon');
      if (I[n] && el.dataset.iconized !== '1') {
        el.innerHTML = I[n];
  ...
  window.Icons = { get, hydrate, raw: I };

  if (document.readyState !== 'loading') hydrate(document);
  else document.addEventListener('DOMContentLoaded', () => hydrate(document));
})();
